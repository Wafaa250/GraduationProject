...
{
    public static class CompanyRequestTeamRecommendationRunStatus
    {
    ...
    public class CompanyRequestTeamRecommendationRun
    {
        ...
        [Column("algorithm_version")] public string AlgorithmVersion { get; set; } = "v1-team-deterministic-semantic";
        [Column("status")] public string Status { get; set; } = CompanyRequestTeamRecommendationRunStatus.Completed;
        ...
        public ICollection<CompanyRequestTeamRecommendation> Teams { get; set; } =
