...
{
    /// <inheritdoc />
    public partial class AddCompanyActivityLogs : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_company_activity_logs_company_profiles_company_profile_id",
                        column: x => x.company_profile_id,
                        principalTable: "company_profiles",
                        principalColumn: "id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_company_activity_logs_users_user_id",
                        column: x => x.user_id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_company_activity_logs_company_profile_id_created_at",
                table: "company_activity_logs",
                columns: new[] { "company_profile_id", "created_at" });

            migrationBuilder.CreateIndex(
                name: "IX_company_activity_logs_user_id",
                table: "company_activity_logs",
                column: "user_id");
        }
