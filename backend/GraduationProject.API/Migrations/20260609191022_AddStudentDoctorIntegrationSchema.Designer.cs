...
namespace GraduationProject.API.Migrations
{
    ...
    [Migration("20260609191022_AddStudentDoctorIntegrationSchema")]
    partial class AddStudentDoctorIntegrationSchema
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("GraduationProject.API.Models.CompanyFollow", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("CompanyProfileId", "StudentProfileId")
                        .IsUnique();

                    b.ToTable("company_follows", (string)null);
                });
            ...
            modelBuilder.Entity("GraduationProject.API.Models.CompanyRequest", b =>
                {
                    ...
                    b.Property<bool>("IsPublishedToHub")
                        .HasColumnType("boolean")
                        .HasColumnName("is_published_to_hub");
                    ...
                    b.Property<DateTime?>("PublishedToHubAt")
                        .HasColumnType("timestamp with time zone")
                        .HasColumnName("published_to_hub_at");
            ...
            modelBuilder.Entity("GraduationProject.API.Models.FeedPostComment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("GraduationProject.API.Models.FeedPostEngagement", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("UserId", "PostKey", "EngagementType")
                        .IsUnique();
            ...
            modelBuilder.Entity("GraduationProject.API.Models.PasswordResetCode", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
            ...
            modelBuilder.Entity("GraduationProject.API.Models.StudentOrganizationEventRegistration", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.HasIndex("EventId", "StudentProfileId")
                        .IsUnique();

                    b.HasIndex("EventId", "SubmittedAt");

                    b.ToTable("student_organization_event_registrations", (string)null);
                });

            modelBuilder.Entity("GraduationProject.API.Models.StudentOrganizationEventRegistrationAnswer", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer")
                    ...
                    b.ToTable("student_organization_event_registration_answers", (string)null);
                });
            ...
            modelBuilder.Entity("GraduationProject.API.Models.User", b =>
                {
                    ...
                    b.ToTable("users", null, t =>
                        {
                            t.HasCheckConstraint("chk_users_role", "role IN ('student', 'doctor', 'company', 'companymember', 'studentassociation', 'association', 'admin')");
                        });
                });
            ...
            modelBuilder.Entity("GraduationProject.API.Models.StudentOrganizationEventRegistrationAnswer", b =>
                {
                    b.HasOne("GraduationProject.API.Models.StudentOrganizationEventRegistrationField", "Field")
                        .WithMany()
                        .HasForeignKey("FieldId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("GraduationProject.API.Models.StudentOrganizationEventRegistration", "Registration")
                        .WithMany("Answers")
                        .HasForeignKey("RegistrationId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
                        .HasConstraintName("FK_student_organization_event_registration_answers_student_or~1");
