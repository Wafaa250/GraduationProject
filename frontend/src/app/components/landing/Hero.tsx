...
By analyzing students’ profiles and project requirements, the system recommends suitable teammates and promotes more effective collaboration.            </p>
            ...
            <div className="flex flex-wrap gap-4">
             <Link to="/register" className="flex items-center gap-2 bg-blue-600 hover:bg-blue-700 text-white px-7 py-3.5 rounded-full font-semibold transition-all shadow-lg hover:shadow-blue-200 hover:-translate-y-0.5">
  Get Started
