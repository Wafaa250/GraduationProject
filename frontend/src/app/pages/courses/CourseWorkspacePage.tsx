...
export default function CourseWorkspacePage() {
  ...
  const handleAddSection = (payload: NewSectionPayload) => {
            ...
            <section style={{ ...card, padding: 0, overflow: "hidden" }} aria-labelledby="cw-projects-title">
              ...
              >
                <div style={{ display: "flex", alignItems: "center", gap: 10, minWidth: 0 }}>
                  ...
                  <div>
                    ...
                    <p style={{ margin: "4px 0 0", fontSize: 12, color: dash.muted, lineHeight: 1.45 }}>
                      Course projects and team settings (local drafts).
                    </p>
                  </div>
                </div>
              ...
              {projects.length > 0 ? (
                ...
                <div style={{ padding: "48px 24px", textAlign: "center" }}>
                  ...
                  >
                    Use <strong style={{ color: dash.text }}>Create Project</strong> to define title, scope, and
                    section targeting. Drafts stay in this browser session until an API is connected.
                  </p>
                </div>
              )}
            </section>
