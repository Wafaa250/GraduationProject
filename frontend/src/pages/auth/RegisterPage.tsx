...
import DoctorRegisterForm from '@/pages/forms/DoctorRegisterForm'
import CompanyRegisterForm from '@/pages/forms/CompanyRegisterForm'
import StudentRegisterForm from '@/pages/forms/StudentRegisterForm'
...
export default function RegisterPage() {
  ...
  const handleContinue = () => {
    ...
    if (selectedRole === 'association') {
      navigate('/register/association' as const)
      return
    }
    setStep(2)
  }
