...
import { getCourseWorkspace, type CourseEnrolledStudent, type CourseProjectWithTeams, type CourseSectionWorkspace, type CourseWorkspaceTeam } from "@/api/doctorCoursesApi";
