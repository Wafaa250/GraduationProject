...
function filterByScope(fields: RecruitmentQuestion[], scope: FormBuilderScope): RecruitmentQuestion[] {
  ...
  if (scope.type === 'campaign') return filterFieldsForCampaignForm(fields as FormFieldDraft[]) as RecruitmentQuestion[]

  return filterFieldsForPositionForm(fields as FormFieldDraft[], {
    id: scope.positionId,
    key: scope.positionKey ?? (scope.positionId != null ? `pos-${scope.positionId}` : ''),
  }) as RecruitmentQuestion[]
