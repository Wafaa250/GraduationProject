...
import type { GraduationNotification } from "./notificationsApi";
import {
  filterEligibleCourseProjects,
  isStudentEligibleForCourseProject,
} from "@/lib/courseProjectEligibility";
...
/** Projects visible to the student based on their enrolled section. */
...
export { isStudentEligibleForCourseProject, filterEligibleCourseProjects };

/** GET /api/courses/projects/{projectId}/my-team — 404 when not on a team. */
...
/** Course notifications scoped to project ids; excludes team invitation events. */
