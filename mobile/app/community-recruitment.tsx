...
export default function CommunityRecruitmentScreen() {
  return (
    <SafeAreaView style={styles.safe} edges={["left", "right", "bottom"]}>
      <OrgScreenHeader title="Recruitment" subtitle="Campus opportunities" onBack={() => router.back()} />
      <View style={styles.body}>
        <Text style={styles.title}>Coming soon</Text>
        <Text style={styles.sub}>
          Discover open roles and recruitment campaigns from campus organizations.
        </Text>
