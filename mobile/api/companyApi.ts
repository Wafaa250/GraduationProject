...
export async function getCompanyProjectRequest(id: number): Promise<CompanyProjectRequestDetail> {
...
export async function updateCompanyProjectRequestStatus(
  ...
  const { data } = await api.patch<CompanyProjectRequestDetail>(`/company/requests/${id}/status`, {
    status,
  });
  return data;
}
...
export async function updateCompanyProjectRequest(
  ...
  const { data } = await api.put<CompanyProjectRequestDetail>(`/company/requests/${id}`, payload);
  return data;
}
...
export async function publishCompanyProjectRequest(
  ...
  const { data } = await api.post<CompanyProjectRequestDetail>(`/company/requests/${id}/publish`);
  return data;
}
...
export async function unpublishCompanyProjectRequest(
  ...
  const { data } = await api.post<CompanyProjectRequestDetail>(`/company/requests/${id}/unpublish`);
  return data;
}
...
export async function generateCompanyRequestTeamRecommendations(
  requestId: number,
  payload: { teamCount?: number; candidatePoolPerRole?: number; forceRegenerate?: boolean } = {},
